                     ...
                     <td class="text-right">
                        <div class="dropdown dropdown-action">
                           ...
                           <div class="dropdown-menu dropdown-menu-right">
                              <a href="{{route('admin.service-type.edit', $row->id)}}" class="dropdown-item"><i class="fa fa-copy m-r-5"></i> Rename</a>                             
                              <a class="dropdown-item" href="{{route('admin.service-type.destroy', $row->id)}}" onclick="return confirm('Are you sure you want to delete this?')"><i class="fa fa-trash-o m-r-5"></i> Delete </a>
                           </div>
                        </div>
                     </td>
                  </tr>
